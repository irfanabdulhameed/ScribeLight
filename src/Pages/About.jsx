      ...
      <div className="flex flex-col  mx-10 py-10">
        ...
        <div className=" lg:px-40 px-4 text-justify lg:text-center md:text-center text-sm md:text-md lg:text-xl text-white">
          <p className="text-neutral-300">
            ...
            solution that’s super easy to use, even if you’re not a tech wizard.
            So, why not give ScribeLight a try? We’re here to help you save time
            and get the most out of your YouTube viewing experience. Dive in,
            and let’s lighten up that content together!
          </p>
        ...
        <div className=" lg:px-40 px-4 text-justify lg:text-center md:text-center text-sm md:text-md lg:text-xl text-white">
          <p className="text-neutral-300">
            Who Are We? We’re five final-year students from Farook College, and
            ScribeLight is our passion project. We’re pretty new to the whole
            tech scene, but we’re diving in with loads of curiosity and
